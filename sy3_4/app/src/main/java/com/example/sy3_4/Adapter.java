...
public class Adapter extends BaseAdapter {
    ...
    List<com.example.sy3_4.Item> list;//item的list对象
    Context context;//上下文对象

    //初始化
    public Adapter(List<com.example.sy3_4.Item> list, Context context) {
    ...
    //根据下标得到列表项
    public com.example.sy3_4.Item getItem(int position) {
